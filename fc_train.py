...
if resume:
  model = pickle.load(open('fc_training/save.p', 'rb'))
else:
  model = {}
  ...
  while True:
    ...
    if done: # an episode finished
      ...
      if episode_number % 100 == 0: 
        pickle.dump(model, open('fc_training/save.p', 'wb'))
        
        reward_ep_cache.append(reward_sum)
        with open("fc_training/reward_ep.txt", "wb") as f:   
          pickle.dump(reward_ep_cache, f)

        reward_rm_cache.append(running_reward)
        with open("fc_training/reward_rm.txt", "wb") as f:   
...
if eval_policy:
  ...
  reward_ep = pickle.load(open('fc_training/reward_ep.txt', 'rb'))
  reward_rm = pickle.load(open('fc_training/reward_rm.txt', 'rb'))

  plt.plot(reward_ep,color='b')
  plt.plot(reward_rm,color='r')
  plt.xlabel('epoch (100 episodes)')
  plt.ylabel('episode reward')
  plt.title('stochastic policy gradient with fully-connect policy')
  plt.savefig('fc_training/reward_plot.png')
